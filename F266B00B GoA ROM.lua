...
LUAGUI_DESC = 'A GoA build for use with the Randomizer. Requires ROM patching. Modified Munny Pouches - Line 738'
...
if ReadByte(Save+0x363C) > ReadByte(Save+0x35C4) then
    local munny = math.random(500, 3000)
    WriteInt(Save+0x2440, ReadInt(Save+0x2440) + munny)
